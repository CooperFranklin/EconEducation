...
from app.classes.data import Quiz2
from app.classes.forms import QuizForm2
from flask_login import login_required
import datetime as dt

rightAnswers = {
    "quiz1":"Passive", "quiz2":"Active", "quiz3":"Passive"
}

@app.route('/quiz2/quiz2', methods=['GET','POST'])
...
def quiz2():
    ...
    return render_template('Quiz_form2.html',form=form)
