...
from app.classes.data import Blog2, Comment
from app.classes.forms import BlogForm2, CommentForm
from flask_login import login_required
import datetime as dt

# This is the route to list all blogs
@app.route('/blog2/list')
@app.route('/blogs2')
...
def blogList():
    ...
    # each blog.
    return render_template('blogs2.html',blogs=blogs)
...
def blog(blogID):
    ...
    return render_template('blog2.html',blog=thisBlog,comments=theseComments)
...
def blogNew():
    ...
    # see how that works.
    return render_template('blogform2.html',form=form)
